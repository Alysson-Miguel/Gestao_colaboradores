...
router.post('/', authenticate, authorize('ADMIN'), asyncHandler(controller.createEmpresa));
router.put('/:id', authenticate, authorize('ADMIN'), asyncHandler(controller.updateEmpresa));
router.delete('/:id', authenticate, authorize('ADMIN'), asyncHandler(controller.deleteEmpresa));
