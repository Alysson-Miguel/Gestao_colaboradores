...
const THEME = {
  dark: {
    ...
    nivelBg: "#1C1C3B", nivelBorder: "#2D2D60", nivelText: "#818CF8",
  ...
  light: {
    ...
    nivelBg: "#EEF2FF", nivelBorder: "#C7D2FE", nivelText: "#4338CA",
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
        {c.nivel && (
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <span style={{ fontSize: 11, color: T.textSubtle, textTransform: "uppercase", letterSpacing: "0.06em" }}>Nível</span>
            <span style={{
              padding: "2px 9px", borderRadius: 999, fontSize: 11, fontWeight: 600,
              background: T.nivelBg, border: `1px solid ${T.nivelBorder}`, color: T.nivelText,
            }}>{c.nivel}</span>
          </div>
        )}
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
